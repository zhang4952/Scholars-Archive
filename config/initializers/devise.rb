...
Devise.setup do |config|
  ...
  # config.pepper = '0e8b2c099e97ed3ff9fd435c550fcd5396ca29b4bae10f9ccd0b68b4d7193efac7a86f9b755763ddf9cc5c56bd640727675b582a5b3c9664f2b3b37a77f8ecf9'
  ...
  # Also need this in config/application.rb
  ...
  # config.cas_follow_url = 'http://test.library.oregonstate.edu'
...
#  config.cas_destination_logout_param_name = application_config["rubycas"]["cas_destination_logout_param_name"]
